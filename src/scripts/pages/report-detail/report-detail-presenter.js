...
export default class ReportDetailPresenter {
  ...
  async saveReport() {
    try {
      // dapatkan report berdasarkan id dan simpan ke indexedDB
      ...
      console.error('savedReport :error', error);
  ...
  //cek ketersediaan data dalam database berdasarkan ID laporan
  async #isReportSaved() {
